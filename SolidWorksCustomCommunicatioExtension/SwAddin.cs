...
namespace SolidWorksCustomCommunicatioExtension
{
    /// <summary>
    /// Summary description for SolidWorksCustomCommunicatioExtension.
    /// </summary>
    [Guid("4c24dea7-7a76-471e-878f-b70e94c401f8"), ComVisible(true)]
    [SwAddin(
        Description = "SolidWorksCustomCommunicatioExtension description",
        Title = "SolidWorksCustomCommunicatioExtension",
        LoadAtStartup = true
        )]
    public class SwAddin : ISwAddin
    {
        ...
        public void AddCommandMgr()
        {
            ...
            icons[0] = iBmp.CreateFileFromResourceBitmap("SolidWorksCustomCommunicatioExtension.toolbar20x.png", thisAssembly);
            icons[1] = iBmp.CreateFileFromResourceBitmap("SolidWorksCustomCommunicatioExtension.toolbar32x.png", thisAssembly);
            icons[2] = iBmp.CreateFileFromResourceBitmap("SolidWorksCustomCommunicatioExtension.toolbar40x.png", thisAssembly);
            icons[3] = iBmp.CreateFileFromResourceBitmap("SolidWorksCustomCommunicatioExtension.toolbar64x.png", thisAssembly);
            icons[4] = iBmp.CreateFileFromResourceBitmap("SolidWorksCustomCommunicatioExtension.toolbar96x.png", thisAssembly);
            icons[5] = iBmp.CreateFileFromResourceBitmap("SolidWorksCustomCommunicatioExtension.toolbar128x.png", thisAssembly);

            mainIcons[0] = iBmp.CreateFileFromResourceBitmap("SolidWorksCustomCommunicatioExtension.mainicon_20.png", thisAssembly);
            mainIcons[1] = iBmp.CreateFileFromResourceBitmap("SolidWorksCustomCommunicatioExtension.mainicon_32.png", thisAssembly);
            mainIcons[2] = iBmp.CreateFileFromResourceBitmap("SolidWorksCustomCommunicatioExtension.mainicon_40.png", thisAssembly);
            mainIcons[3] = iBmp.CreateFileFromResourceBitmap("SolidWorksCustomCommunicatioExtension.mainicon_64.png", thisAssembly);
            mainIcons[4] = iBmp.CreateFileFromResourceBitmap("SolidWorksCustomCommunicatioExtension.mainicon_96.png", thisAssembly);
            mainIcons[5] = iBmp.CreateFileFromResourceBitmap("SolidWorksCustomCommunicatioExtension.mainicon_128.png", thisAssembly);
